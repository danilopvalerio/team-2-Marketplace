...
public class VendaViewTest {
        ...
        public void testFinalizarCompra() {
                Comprador comprador = new Comprador("Leticia", "leticia@email.com", "senha123", "123.456.789-00",
                                "Rua A, 123");
        ...
        public void testFinalizarCompraComConfirmacaoNegativa() {
                ...
                Produto produto = new Produto("Smartphone", 2500.0f, "Eletrônico", 5, "Samsung", "Última geração",
                                "P002",
                                "12.345.678/0001-99");
                ...
                // Registrar e depois remover a venda
                VendaController vendaController = new VendaController();
                vendaController.registrarVenda(venda);
                vendaController.removerVenda("V002");

                // Verificar se a venda não existe mais
                ...
                ProdutoController.deleteProdutoPorID("P002");
        }
}
